...
# TestLoopSuppressesRepeatedCompletedToolCall()

## Connections
- [[NewEchoTool()]] - `calls` [INFERRED]
- [[T_13]] - `references` [EXTRACTED]
- [[loop_test.go]] - `contains` [EXTRACTED]
- [[testPromptBuilder()]] - `calls` [EXTRACTED]
